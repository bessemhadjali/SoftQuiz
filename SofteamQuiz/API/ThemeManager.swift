...
final class ThemeManager {
   ...
   private var themes = [Theme]()
    ...
    init() {
        let question1 = Question(id: 1, questionText: "q1", rule: "r1", options: ["a", "b", "c", "d"], correctAns: 2, wrongAns: -1, isAnswered: false)
        ...
        let theme1 = Theme(id: 1, title: "T1", score: 10, subThemes: [subTheme1, subTheme2])

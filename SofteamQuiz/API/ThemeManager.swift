   ...
   private var themes = [Theme]()
    ...
    init() {
       // Les règles d'utilisation relatives à la confidentialité des informations clients, à la sécurité des ressources informatiques et des moyens de communication électronique s'appliquent à TOUT MOMENT : avant mission, durant la mission et après la mission
        ...
        let question2 = Question(id: 1, questionText: "Question_1 : Un document du client obtenu pendant votre mission ne doit pas être divulgué à l'extérieur du client même après la fin de missionmissionmissionmissionmissionmissionmissionmissionmissionmissionmission", rule: "Les règles d'utilisation relatives à la confidentialité des informations clients, à la sécurité des ressources informatiques et des moyens de communication électronique s'appliquent à TOUT MOMENT : avant mission, durant la mission et après la mission", options: ["La question ne se pose pas car après la fin de la mission le consultant ne doit plus être en possession du document.", "La question ne se pose pas car après la fin de la mission le consultant ne doit plus être en possession du document.", "Cela dépend du contenu du document", "La question ne se pose pas car après la fin de la mission le consultant ne doit plus être en possession du document."], correctAns: 2, wrongAns: -1, isAnswered: false)
//        let question2 = Question(id: 2, questionText: "q2", rule: "r3", options: ["a", "b", "c", "d"], correctAns: 1, wrongAns: -1, isAnswered: false)
        ...
        let subTheme1 = SubTheme(id: 1, title: "Champ d'application : Qui est concerné, Quand s'appliquent les règles, et qu'est-ce qui est couvertcouvertcouvertcouvertcouvertcouvertcouvertcouvertcouvertcouvertcouvertcouvertcouvertcouvertcouvertcouvertcouvertcouvert", questions: [question1, question2, question3])
        ...
        let theme1 = Theme(id: 1, title: "Règles d'utilisation et d'engagement relatives à la confidentialité, aux outils informatiques et moyens de communication électroniqueélectroniqueélectroniqueélectroniqueélectroniqueélectroniqueélectroniqueélectroniqueélectroniqueélectroniqueélectroniqueélectroniqueélectroniqueélectroniqueélectroniqueélectroniqueélectroniqueélectroniqueélectroniqueélectronique", score: 10, subThemes: [subTheme1, subTheme2])

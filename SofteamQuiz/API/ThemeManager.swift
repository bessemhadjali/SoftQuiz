...
final class ThemeManager {
   ...
   private var themes = [Theme]()
    ...
    init() {
        ...
        let question3 = Question(id: 3, questionText: "q3", rule: "r3", options: ["a", "b", "c", "d"], correctAns: 1, wrongAns: -1, isAnswered: false)
        ...
        let question7 = Question(id: 7, questionText: "q7", rule: "r7", options: ["a", "b", "c", "d"], correctAns: 1, wrongAns: -1, isAnswered: false)
        ...
        let theme1 = Theme(id: 1, title: "T1", score: 0, subThemes: [subTheme1, subTheme2])
